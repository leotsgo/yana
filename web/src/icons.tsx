...
// Paths are from Lucide (ISC). Only what the chrome uses is here; add to
// the map, not to the bundle. Icons are decorative; the button that holds one carries the
// label or the title.
