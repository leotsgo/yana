// The icon set: inline SVG, 24-unit grid, 1.75px stroke, current colour.
// Paths are from Lucide (ISC) except `slash`, which is the wordmark's
// mark. Only what the chrome uses is here; add to the map, not to the
// bundle. Icons are decorative; the button that holds one carries the
// label or the title.
...
const paths: Record<string, string> = {
  ...
  capture: '<path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z"/>',
